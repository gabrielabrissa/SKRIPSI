<div id="modal2-{{ $id2 }}" class="modal fade" data-backdrop="static" tabindex="-1">
          ...
          <table class="table table-bordered -mb-1">
            <tbody>
              <tr>
                ...
                <td class="fw-semibold text-xs">{{ $c->SUPP_SITE_ID}}</label></td>
              </tr>
              <tr>
            ...
            <div class="card mb-0">
              <div class="card-header pb-0">
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                  data-target="#modal3-{{ $id2 }}">Add FP</button>
