...
<ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
  ...
  <li class="breadcrumb-item text-sm text-white active" aria-current="page">Monitoring File FP</li>
</ol>
<h6 class="font-weight-bolder text-white mb-0">Monitoring File Faktur Pajak </h6>
@endsection
        ...
        <div class="col-md-8">
          ...
          <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0">Laporan Monitoring File Fisik Faktur Pajak</p>
              </div>
            </div>
            <div class="card-body">
            <div class="row">
